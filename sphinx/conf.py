...
# -*- coding: utf-8 -*-
#
# ctypes-gen documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ctypes-gen.tex', 'ctypes-gen Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ctypes-gen', 'ctypes-gen Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ctypes-gen', 'ctypes-gen Documentation',
     author, 'ctypes-gen', 'One line description of project.',
     'Miscellaneous'),
]
