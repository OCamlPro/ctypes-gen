...
If :code:`ctypes-gen` is available in your opam repository, you can just call::

  opam install ctypes-gen

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`ctypes-gen` in a directory.
